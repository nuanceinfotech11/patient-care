      ...
      @include('panels.flashMessages')
        <!-- datatable start -->
          ...
          <div class="col s12 m6 l6 add-btn" style="text-align:end;margin-left:232px;">
                  <div class="btn">
                    <a href="{{route('manager-patient-create')}}">
        ...
        <div class="responsive-table table-result">
          @include('pages.manager-patient.manager-patient-list-ajax')
...
<script>
  $(document).ready(function(){
    var paginationUrl = '{{(isset($paginationUrl) && $paginationUrl!='') ? route($paginationUrl) : route("manager.paitent-list") }}';
