    ...
    <div class="card">
      ...
      @include('panels.flashMessages')
        ...
        <div class="responsive-table table-result">
          @include('pages.stockin.stockin-list-ajax')
...
<script>
  $(document).ready(function(){
   // var paginationUrl = '{{(isset($paginationUrl) && $paginationUrl!='') ? route($paginationUrl) : route("stockin-list") }}';
   var paginationUrl = '{{(isset(auth()->user()->role()->first()->name) && auth()->user()->role()->first()->name=="superadmin") ? route("stockin-list") : route("admin-stockin-list") }}';
