    ...
    <div class="card">
      ...
      @include('panels.flashMessages')
        <!-- datatable start -->
          ...
          <div class="col s12 m6 l6 add-btn" style="text-align:end;">
                  <div class="btn" style="margin-right:-215px;">
                    <a href="{{route('admin-patient-schedule-create')}}">
        ...
        <div class="responsive-table table-result">
          @include('pages.admin-patient-schedule.patient-schedule-list-ajax')
...
<script>
  $(document).ready(function(){
    var paginationUrl = '{{(isset($paginationUrl) && $paginationUrl!='') ? route($paginationUrl) : route("admin.patient-schedule-list") }}';
