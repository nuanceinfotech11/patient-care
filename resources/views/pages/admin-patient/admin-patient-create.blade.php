...
<script>
  window.onload=function(){
    ...
    var marital_status = "{{(isset($usermeta[0]->marital_status) && $usermeta[0]->marital_status!='NULL') ? $usermeta[0]->marital_status : old('marital_status')}}";
